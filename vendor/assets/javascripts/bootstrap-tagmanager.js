  ...
  jQuery.fn.tagsManager = function (options,tagToManipulate) {
    ...
    var pushTag = function (tag) {
      ...
      if (alreadyInList) {
        ...
        html += '<span class="label label-tag'+cl+'" id="' + newTagId + '"><span>' + tag + '&nbsp;&nbsp;</span><a href="#" class="myTagRemover" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '" title="Remove">' + tagManagerOptions.tagCloseIcon + '</a></span> ';
